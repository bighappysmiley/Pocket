...
if ! strings "$BIN_PATH" 2>/dev/null | grep -q 'POCKET-LIVE-v27'; then
  say "WARNING: bin does not contain POCKET-LIVE-v27 — you may have an old download."
...
say "Serial MUST show:  *** POCKET-LIVE-v27-status-chrome ***"
