...
if ! strings "$BIN_PATH" 2>/dev/null | grep -q 'POCKET-LIVE-v28'; then
  say "WARNING: bin does not contain POCKET-LIVE-v28 — you may have an old download."
...
say "Serial MUST show:  *** POCKET-LIVE-v28-font-sd-audio ***"
