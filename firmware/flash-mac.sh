...
if ! strings "$BIN_PATH" 2>/dev/null | grep -q 'POCKET-LIVE-v10'; then
  say "WARNING: bin does not contain POCKET-LIVE-v10 — you may have an old download."
...
say "Serial MUST show:  *** POCKET-LIVE-v10-console-uart ***"
say "Then: wiping factory image → Welcome to Pocket."
say "If you only see 'Multicore app' and NEVER that banner, you flashed an old bin — re-download."
